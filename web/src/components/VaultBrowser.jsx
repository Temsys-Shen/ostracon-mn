...
p{max-width:72ch}img{max-width:100%!important}svg{max-width:100%}pre{position:relative;max-width:100%;overflow:auto;padding:12px 14px;border:1px solid #d8dde6;border-radius:5px;background:#f5f7fa;white-space:pre-wrap}
...
mjx-stretchy-v{-webkit-transform:translateZ(0);transform:translateZ(0);-webkit-backface-visibility:hidden;backface-visibility:hidden}
